...
State in class components goes into the constructor such as:
constructor(){
    super();
    this.state = {mystate: ''}
}
...
Mounting - component first is assigned to the page.
Updating - component has some stateful change that causes a rerender.
Unmounting - component is removed.

3. Demonstrate an understanding of class component lifecycle methods.

componentDidMount - Applies side-effect logic on the initial render of the component.
componentDidUpdate - Applies side-effect logic every time a component's state updates.
componentDidDismount- Usually used for clean-up after a component is removed from the page.

4. Define stateful logic.

Stateful logic is the logic involving state that doesn't involve the visual representation of the state.

5. Describe how to test a React component with React Testing Library.

Use the basic arrange, act, assert process to get the components, perform actions on them, and test their behavior according
